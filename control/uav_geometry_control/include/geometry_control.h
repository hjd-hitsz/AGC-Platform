...
public:
    ...
    /// @param kw gain of angular velocity error
    /// @param kw gain of SO(3) attitude error
    /// @param static_thrust_rate thrust_rate at the static position in 0 and 1
    GeometryControl(Eigen::Vector3d kp, 
                    Eigen::Vector3d kv, 
                    Eigen::Vector3d kw, 
                    double static_thrust_rate);
    ~GeometryControl(){}
    /// @brief compute geometry control command
